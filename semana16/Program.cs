...
class Grafo
{
    private Dictionary<string, List<string>> adyacencia = new();
    ...
    // Calcula las métricas de centralidad
    public void CalcularMetricas()
    {
        ...
        foreach (var n in adyacencia.Keys)
            betweenness[n] = 0.0;
    ...
    // Calcula la suma de distancias desde un nodo a todos los demás
